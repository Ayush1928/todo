...
const EditTodoButton: React.FunctionComponent<IEditTodoButtonProps> = ({ todo }) => {
                                    ...
                                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                        <div className="sm:flex w-full sm:items-start">
                                            <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                                                <Pencil className="h-6 w-6 text-red-600" aria-hidden="true" />
                                            </div>
                                            <div className="mt-3 w-full text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                ...
                                                <div className="mt-2 w-full">
                                                    <input className="bg-gray-200 w-full rounded-md" value={editedTitle} onChange={(event) => setEditedTitle(event.target.value)}/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
